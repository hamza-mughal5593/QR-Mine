...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    @Override
    public void processBitmap(Bitmap bitmap, final GraphicOverlay graphicOverlay, boolean b) {
    ...
    private Task<T> requestDetectInImage(
            ...
            long frameStartMs, boolean scan) {
        ...
        return detectInImage(image)
                .addOnSuccessListener(
                        ...
                        results -> {
                            ...
                            VisionProcessorBase.this.onSuccess(results, graphicOverlay,scan);
    ...
    protected abstract void onSuccess(@NonNull T results, @NonNull GraphicOverlay graphicOverlay, boolean scan);
